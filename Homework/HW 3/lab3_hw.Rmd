...
```{r}
str(homerange)
#of course glimpse would also give this information
```
```{r}
summary(homerange)
```
...
Using log10.hra you actually get the Namaqua dwarf adder as the smallest snake
